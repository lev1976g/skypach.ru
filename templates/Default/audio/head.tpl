...
<div class="player_container" id="player_container">
 ...
 <div class="player_progreebar fl_l cursor_pointer" style="width:60px;margin-left:10px;" id="player_volume_bar" onClick="music.volume()">
...
<div class="search_sotrt_tab" style="width:150px;margin-top:-14px;margin-left:434px;z-index:1">
...
<a href="/id{uid}" onClick="Page.Go(this.href); return false;"><div>[not-owner]К странице {name}[/not-owner][owner]К моей странице[/owner]</div></a>
