<div class="msg_one [new]msg_new[/new]" id="bmsg_{mid}">
 <div class="msg_pad">
  ...
  <a href="/messages/show/{mid}" onClick="Page.Go(this.href); return false"><div class="msg_right_col" style="margin-left:15px;"><span>{subj}</span><div style="width: 340px">{text}&nbsp;</div><div>{attach}</div></div></a>
