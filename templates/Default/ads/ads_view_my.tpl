...
<div class="button_div_gray margin_left" id="editClose"><button onClick="ads.edit_close('{id}')">Отмена</button></div>

<div class="button_div_gray margin_left"><button onclick="ads.delete_ads('{id}');">Удалить обявление</button></div>
