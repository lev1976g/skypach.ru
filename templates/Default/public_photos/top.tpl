...
$(document).ready(function(){
  langNumric('langNumricAll', '{x-photoss-num}', 'фотография', 'фотографии', 'фотографий', 'фотография', 'фотографией');
});
var page_cnt = 1;
function videoAddedLoadAjax(){
  ...
  $.post('/index.php?go=public_photos&act=search', {page: page_cnt, query: $('#query_audio').val(), pid: '9'}, function(d){
    ...
    $('#wall_l_href_audio_se_load').html('Показать больше фотографий');
...
<div class="clear"></div>
<div id="seResult">
<div class="allbar_title" style="margin-bottom:0px;[yes]border-bottom:0px[/yes]">{videos-num} фотограий | <a href="/{adres}" onClick="Page.Go(this.href); return false" style="font-weight:normal">К сообществу</a></div>
[no]<div class="info_center"><br /><br /><br />В сообществе еще нет фотографий.<br /><br /><br /></div>[/no]
...
<div class="button_div_gray fl_r">
  <button id="upload_2" class="  ">Загрузить новую фотографию</button>
</div>