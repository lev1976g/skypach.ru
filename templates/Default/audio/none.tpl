...
<div class="search_form_tab" style="margin-top:-9px">
 <div class="buttonsprofile albumsbuttonsprofile buttonsprofileSecond" style="height:22px">
  ...
  [owner]<a href="/audio{uid}" onClick="audio.addBox(); return false;"><div><b>Добавить аудиозапись</b></div></a>[/owner]
  <a href="/id{uid}" onClick="Page.Go(this.href); return false;"><div><b>[not-owner]К странице {name}[/not-owner][owner]К моей странице[/owner]</b></div></a>
 </div>
</div>
...
[owner]<img src="http://slon.ru/images2/blog_photo_17/14_05_12/dogs/band.png" width="520px"><br><br>Здесь Вы можете хранить Ваши аудиозаписи.<br />
...
[not-owner]<img src="http://slon.ru/images2/blog_photo_17/14_05_12/dogs/band.png" width="520px"><br><br>У пользователя ещё нет аудиозаписей.[/not-owner]<br /><br /><br /><br />
</div>