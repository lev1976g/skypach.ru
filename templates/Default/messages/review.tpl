<link type="text/css" rel="stylesheet" href="http://st0.userapi.com/css/al/profile_edit.css?26">
...
<div id="profile_editor" style="width:627px;margin-left:-12px;margin-top:-13px;"><br><br><br>
...
</div></div><div style="margin-top:-37px"></div>
