...
<div class="head">
 <div class="autowr">
  <a href="/" class="udinsMy" onClick="Page.Go(this.href); return false;"></a>
  <div class="headmenu">
   <a href="/?act=logout">
...
<div class="autowr"><style>.content{width:633px}</style>
 <div class="content" style="width:810px;">
  <div class="cont_border_left">
   <div class="cont_border_right">
    <div class="speedbar" id="speedbar">Страница удалена</div>
    <div class="padcont">
	 <div class="info_center">Ваша страница была удалена администрацией.</div>
	 <div class="clear"></div>
	</div>
   </div>
  </div>
