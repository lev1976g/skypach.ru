...
<input type="text" class="videos_input" style="width:550px" maxlength="65" id="title_n" value="{title}" />
...
<textarea class="videos_input wysiwyg_inpt" style="width:548px" id="text" name="text">{text}</textarea>
<div class="input_hr"></div>
<div class="clear"></div>
<div class="button_div fl_l"><button onClick="notes.editsave({note-id}); return false" id="notes_sending">Сохранить изменения</button></div>
