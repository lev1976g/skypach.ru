...
<input type="text" class="videos_input" style="width:550px" maxlength="65" id="title" />
...
<textarea class="videos_input wysiwyg_inpt" style="width:548px" id="text" name="text"></textarea>
<div class="clear"></div>
