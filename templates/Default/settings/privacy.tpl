...
<div class="texta color_000" style="width:350px">Кто может писать мне личные <b>сообщения</b>:</div>
...
<div class="texta color_000" style="width:350px">Кто видит чужие записи на моей <b>стене</b>:</div>
...
<div class="texta color_000" style="width:350px">Кто может оставлять сообщения на моей <b>стене</b>:</div>
...
<div class="texta color_000" style="width:350px">Кто может комментировать мои <b>записи</b>:</div>
...
<div class="texta color_000" style="width:350px">Кто видит основную информацию моей <b>страницы</b>:</div>
