...
<div style="width:310px"><b>{name}</b>, в целях безопасности вашего аккаунта администрация <b>УдинБала</b> рекомендует вам регулярно менять пароль. Эта процедура не займет у вас много времени, но значительно уменьшит риски доступа третьих лиц к вашей учетной записи. Для изменения пароля к аккаунту введите новый пароль в специальное поле под данным сообщением.</div>
