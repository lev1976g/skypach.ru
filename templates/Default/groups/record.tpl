[record]<div class="wallrecord wall_upage public_wall" id="wall_record_{rec-id}" style="padding-bottom:5px;margin-top:5px">
 ...
 <div style="float:left;width:84%;margin-left:0px">
 ...
 <div class="wall_tell cursor_pointer" onMouseOver="myhtml.title('{rec-id}', 'Рассказать друзьям', 'wall_tell_')" onClick="groups.wall_tell('{rec-id}'); return false" id="wall_tell_{rec-id}" [owner]style="margin-top:2px;margin-right:5px"[/owner]></div>
