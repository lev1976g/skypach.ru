<div class="onevideo" id="v{id}">
 ...
 <div class="onevideo_inf">{translate=lang_239} {date}</div>
 [admin-group]<div class="onevideo_inf" id="addVideoForPublic{id}"><a class="cursor_pointer" onClick="videoPubEditBox('{id}', '{pid}'); return false">{translate=lang_34}</a> &nbsp; | &nbsp; <a class="cursor_pointer" onClick="delVideoOutPublic('{id}', '{pid}'); return false">{translate=lang_37}</a></div>[/admin-group]
</div>
<div class="clear"></div>