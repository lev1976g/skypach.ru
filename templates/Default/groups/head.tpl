...
<div class="t_bar tabs clear_fix" style="margin-top:-10px;width:607px;margin-left:-12px;">
  <ul class="t0" id="groups_list_tabs">
    ...
    <li class="" style="" id="groups_tab_admin">
    ...
    <li class="" style="" id="groups_tab_admin">
      <a href="/?go=groups&act=requests" onmousedown="nav.go(this, event)" onClick="Page.Go(this.href); return false;">
        <b class="tl1"><b></b></b><b class="tl2"></b>
        <b class="tab_word">Приглашения</b>
      </a>
    </li>
    <li class="t_r">
